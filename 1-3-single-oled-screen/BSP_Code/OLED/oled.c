...
void OLED_Init(void)
{
	...
	//输出模式
	gpio_output_options_set(OLED_SCL_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_25MHZ, OLED_SCL_PIN);
	gpio_output_options_set(OLED_SDA_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_25MHZ, OLED_SDA_PIN);
	gpio_output_options_set(OLED_RES_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_25MHZ, OLED_RES_PIN);
	gpio_output_options_set(OLED_DC_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_25MHZ, OLED_DC_PIN);
	gpio_output_options_set(OLED_CS_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_25MHZ, OLED_CS_PIN);
